...
public class oAuthBase2
{
    ...
    protected string NormalizeRequestParameters(IList<QueryParameter> parameters)
    {
        ...
        {
            p = parameters[i];
            sb.AppendFormat("{0}={1}", p.Name, UrlEncode(HttpUtility.UrlDecode(p.Value)));
    ...
    public string GenerateSignatureBase(Uri url, string consumerKey, string token, string tokenSecret, string httpMethod,
                                    ...
                                    out string normalizedUrl, out string normalizedRequestParameters)
    {
        ...
        switch (signatureType)
        {
            ...
            case SignatureTypes.HMACSHA1:
                var signatureBase = GenerateSignatureBase(url, consumerKey, token, tokenSecret, httpMethod, timeStamp,
                                                             nonce, HMACSHA1SignatureType, out normalizedUrl,
